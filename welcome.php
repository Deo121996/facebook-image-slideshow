...
<head>
    ...
    <style>
        body {font: normal 0.9em Arial;color:#ddd;background:linear-gradient(to right,  
	 #6666ff , #1a1aff);;}
...
<body>
	...
	<div style="background: linear-gradient(to right,  
	 #6666ff , #1a1aff); ; height:40px;"></div>
    <div style="padding:0px ;background: linear-gradient(to right,  
	 #6666ff , #1a1aff);align:right;">
    
	<div style="width:20%;height:100%;">
		<img src="img/1.jpg" width="100px" height="100px" style="border-radius:50%;margin-left:10px;margin-top:20px"/><a href="#"><h3 style="margin-left:20px;color:white; font-family:calibri;text-decoration: none;">Albert Roy</h3></a>	
	</div>
